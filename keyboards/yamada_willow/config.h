...
#define PRODUCT_ID   0x1519
#define DEVICE_VER   0x0001
#define MANUFACTURER Daraku-Neko
#define PRODUCT      Yamada Willow
 ...
 *
 */
#define MATRIX_ROW_PINS { F4, F5, F6, F7, B1, B3, B2, B6, D2, D1 }
#define MATRIX_COL_PINS { F4, F5, F6, F7, B1, B3, B2, B6, D2, D1 }
