...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT(
    //|-----------------------------------------------------|                    |---------------------------------------------------------------|
       UC_M_WC, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,                      STARX, NUKE, SUNGL,   KC_AUSSIE,  KC_BLOCKS,   KC_NOMODE,
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+------------------|
       UC_M_LN, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,                      ZHAP,   ARWUP, ZAP, KC_REGIONAL, KC_WIDE, KC_SCRIPT,
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+------------------|
       RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                        UNIT,      UNIT2,     UNIT3,       UNIT4,    RWORD, MO(_ADJUST),
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+------------------|
