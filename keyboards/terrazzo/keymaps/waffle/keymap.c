...
<<<<<<< HEAD
	    TZ_OFF,           KC_LALT, KC_LGUI,          LWRSPC,           RAISE,            KC_RGUI,  TG(_EXTRA)
=======
	    TZ_OFF,           KC_LALT, KC_LGUI,          LWRSPC,           RAISE,            KC_RGUI,  KC_RALT
>>>>>>> 07e70f0eccdb840d48a19003900173b73eb7508d
    ),
    ...
    [_EXTRA] = LAYOUT(
        _______, KC_CAPS, KC_Q, KC_W, KC_E, KC_R, KC_T, _______, _______, _______, _______, _______, _______,
        _______, KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G, _______, _______, _______, _______,          _______,
        _______, KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, _______, _______, _______, _______,          _______,
        _______,          _______, KC_SPC,          KC_SPC,          _______,          _______, TG(_EXTRA)
    )
};
