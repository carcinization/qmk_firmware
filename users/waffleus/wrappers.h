...
#define ________________CRKBDQWERTY4_______________ MSLGTD, LOWER, KC_SPC, KC_BSPC, RAISE, KC_MS_R
...
#define ________________CRKBDLOWER3________________ KC_NLCK, CTLESC, KC_TAB, KC_CAPS, KC_TILD, KC_GRV, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_RCTL, CMDS
#define ________________CRKBDLOWER4________________ KC_LGUI, KC_TRNS, KC_SPC, KC_VOLU, KC_MS_U, KC_PGUP

#define ________________CRKBDRAISE1________________ UC_M_WC, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS,  CG_NORM, CG_SWAP, UNIT, UNIT2, UNIT3, UNIT4
